...
<div id="footer">
  ...
  <div class="container">
    <div class="four columns">
      ...
      <p class="margin-top-15">Add a dash of style to your morning runs, workout sessions and weekend adventures with performance enhancing and utterly fashionable men’s sports shoes. AJIO brings to you a handpicked collection of vibrant running shoes, snug football shoes and more from the best sports brands, Indian and international.
      </p>
    </div>
    <div class="four columns">
      <!-- Headline -->
